...
cy %>% 
  ...
  summarize(mean = mean(pred), sd = sd(pred))
...
cy_meansd <- cy %>% group_by(condition, consistency) %>% 
...
cy_emp <- merge(x = sum_varyslope_RT, y = cy[,c("ID", "s_totalemp", "s_affemp", "s_cogemp")], by = "ID")
...
p_RTemp <- ggplot(data = cy_emp, aes(y = s_slope_RT, x = s_totalemp)) + 
  geom_point() + 
  geom_smooth(aes(y = s_slope_RT, x = s_totalemp), method = lm, color = "slategray4") +
...
ggplot(data = cy_emp) + 
  ...
  geom_smooth(aes(y = s_slope_RT, x = s_totalemp), method = lm, color = "black") +
  #cognitive
  geom_point(aes(y = s_slope_RT, x = s_cogemp, color = "Cognitive Empathy")) + 
  geom_smooth(aes(y = s_slope_RT, x = s_cogemp), method = lm, color = "skyblue") +
  #affective
  geom_point(aes(y = s_slope_RT, x = s_affemp, color = "Affective Empathy")) + 
  geom_smooth(aes(y = s_slope_RT, x = s_affemp), method = lm, color = "slategray4") +
...
p_Error_emp <- ggplot(data = y_emp, aes(y = s_vary_slope_E, x = s_totalemp)) + 
  geom_point() + 
  geom_smooth(aes(y =s_vary_slope_E, x = s_totalemp), method = lm, color = "slategray4") +
...
ggplot(data = y_emp) + 
  ...
  geom_smooth(aes(y = s_vary_slope_E, x = s_totalemp), method = lm, color = "black") +
  #cognitive
  geom_point(aes(y = s_vary_slope_E, x = s_cogemp, color = "Cognitive Empathy")) + 
  geom_smooth(aes(y = s_vary_slope_E, x = s_cogemp), method = lm, color = "skyblue") +
  #affective
  geom_point(aes(y = s_vary_slope_E, x = s_affemp, color = "Affective Empathy")) + 
  geom_smooth(aes(y = s_vary_slope_E, x = s_affemp), method = lm, color = "slategray4") +
